...
public class DirectWriterTest extends AbstractWriterTest {
	...
	public void testDiffTablesCreation() throws Exception {
		...
		docWriter.addPageHeader(new String[] { "Table With First Big Column And Small Last Column",
				"Listing of Records" });
	...
	private void createSimpleTable(int cols, String colWidthType, int vals, int innerIndex, boolean simple)
			throws Exception {
		// start table
